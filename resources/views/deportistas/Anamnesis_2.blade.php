...
<form action="" method="post"><!-- Falta asignar el action -->
        ...
        <div class="row">
            <div class="col-2">
                <a href="{{ url('/anamnesis_1') }}"><img id="fle1" src="../img/flechas_1.png" alt="atras" width="30%"></a>
            </div>
            <div class="col-8">
                <br>
            ...
            <div class="col-2">
                <a href="{{ url('/anamnesis_3') }}"><img id="fle" src="../img/flechas.png" alt="siguiente" width="30%"></a>
            </div>
        </div>
    </form>
@endsection
