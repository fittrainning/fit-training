                            ...
                            <form action="{{route("entrenador.store")}}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12" id="colo">
                                        <input type="hidden" name="Ent_Usu_id" value="{{ Auth::user()->Usu_id }}" readonly>
                                        <div class="row d-flex justify-content-center">
                                            <div id="color" class="form-group row">
                                                ...
                                                <div id="let3" class="col-lg-8">
                                                    <select name="Ent_ficha">
                                                        @foreach($fichas as $ficha)
                                                            <option value="{{ $ficha->Fed_cod }}">{{ $ficha->Fed_cod }} - {{ $ficha->Fed_nombre }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row d-flex justify-content-center">
                                            <div id="color" class="form-group row">
                                                <label class="col-lg-4 col-form-label text-lg-left">Nivel de Formacion</label>
                                                <div id="let3" class="col-lg-8">
                                                    <input type="text" name="Ent_nivel_de_formacion" value="">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row d-flex justify-content-center">
